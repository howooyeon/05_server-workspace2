...
public class MyFileRenamePolicy implements FileRenamePolicy{
	...
	public File rename(File originalFile) {
		...
		// 원본파일명("aaa.jpg")
		String originName = originalFile.getName();
		
		// => 수정파일명("2023081712251212345.jpg")
		...
		return new File(originalFile.getParent(), changeName); // 원본의 디렉토리를 알아낸후 변경된 이름으로 저장하는 메소드
	}
